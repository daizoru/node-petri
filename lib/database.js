...
(function() {
  ...
  module.exports = (function() {
    ...
    exports.prototype.remove = function(item, onComplete) {
      ...
      work = function() {
        ...
        if (id != null) {
          dv = _this._[id];
          delete _this._[id];
          idx = _this.batch.indexOf(id);
          if (idx > -1) {
            _this.batch.splice(idx, 1);
          }
          _this.length--;
        }
        r = void 0;
    ...
    exports.prototype.next = function() {
      ...
      next = this.batch.shift();
      if (this._[next] == null) {
        console.log("batch: " + this.batch + " next: " + next);
        console.log(pretty(this._));
      }
      return this._[next];
    };
