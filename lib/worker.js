...
(function() {
  var P, agent, cluster, deck, inspect, makeId, map, mutable, mutate, pick, sha1, timmy, wait, _ref, _ref1, _ref2,
  ...
  module.exports = function(options) {
    ...
    return process.on('message', function(msg) {
      ...
      return agent = eval(agentMeta.src)(master, agentMeta.options);
    });
  };
