...
(function() {
  ...
  module.exports = (function() {
    ...
    function exports(root, values) {
      var value, _i, _len, _ref;
      this.root = root;
      this.values = values != null ? values : ['energy'];
    ...
    exports.prototype.begin = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        value = _ref[_i];
        this._[value].min = void 0;
        this._[value].max = void 0;
        _results.push(this._[value].avg = void 0);
      }
      return _results;
    };

    exports.prototype.measure = function(worker) {
      var ab, sb, value, _i, _len, _ref, _results;
      _ref = this.values;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        value = _ref[_i];
        ...
        _results.push(sb.max = sb.max != null ? (ab > sb.max ? ab : sb.max) : ab);
      }
      return _results;
    };
    ...
    exports.prototype.end = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        value = _ref[_i];
        if (this._.pool_size) {
          this._[value].avg / this._.pool_size;
        } else {
          0.0;
